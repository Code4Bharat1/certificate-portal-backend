...
const clientLetter = async (req, res) => {
    try {
        ...
        pdfDoc.on("end", async () => {
            ...
            // 🟢 Save form data to DB before sending PDF
            const createdData = await clientdataModel.create({
                name,
                category,
                issueDate,
                letterType,
            ...
            console.log("Client Letter Data Saved:", createdData);

            // 🟢 Send PDF to frontend (same logic as before)
