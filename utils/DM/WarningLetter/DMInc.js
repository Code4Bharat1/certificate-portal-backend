...
const drawDMIncompleteAssignment = async (
  ctx,
  width,
  height,
  data,
  ...
  const paragraph1 = `This  is to formally inform you that you have failed to submit your assignment / project work for **${subjectName}**, titled **${projectName}**, within the stipulated deadline as required under the **Digital Marketing (DM)** program conducted by **Nexcore Alliance LLP**.`;
...
export default drawDMIncompleteAssignment;
