...
const companyPara = `** Nexcore Alliance LLP,**a company incorporated under the**Limited Liability Partnership Act, 2008,**having its registered office at**Office No. 2, White House Bldg No. 3, Kurla West Basement, SG Barve Marg, Mumbai, Maharashtra 400 070, India,**hereinafter referred to as the "Company";`;    const companyParts = parseMarkdown(companyPara);
    ...
    const section1Items = [
      "(a) Employee records, personal information, resumes, salaries, attendance reports, and internal HR documents.",
      "(b) Recruitment strategies, interview processes, selection criteria, and onboarding materials.",
      "(c) Company policies, training modules, operational procedures, internal reports, and communication records.",
      "(d) Payroll data, employee performance reports, disciplinary records, and internal grievance documents.",
      "(e) Any other non-public information that provides a competitive or operational advantage to the Company.",
    ];
    ...
    // (a)
    const section2a =
      "(a) **Return of Company Assets:** The Recipient agrees that:Upon termination of employment, the Recipient shall return all Company assets, including but not limited to:HR documents,Access credentials,Company IDs,Data files,Internal reports,Any digital/physical materials belonging to the Company";
    ...
    const section2cItems = [
      "• Engage with any competitor to share HR processes or internal information",
      "• Solicit Company employees, interns, or clients",
      "• Influence employees to resign or join other organizations",
    ];
    ...
    const section3Items = [
      ...
      "• **Blacklist the Recipient from HR/operations employment opportunities via legal channels.**",
    ];
