...
const drawHRPunctuality = async (
  ...
  const bullet2 = `• Continued non-compliance may result in disciplinary action, including formal warnings, salary adjustments, or other corrective measures, as per Company policy.`;
  ...
  ctx.font = "bold 18px 'Times New Roman'";
  const paragraph = `Kindly treat this letter as an official warning.`;
  currentY = wrapText(ctx, paragraph, leftMargin, currentY, contentWidth, 19);
  currentY += 15;
...
export default drawHRPunctuality;
