// utils/BVOC/CommitteeLetter/President.js
import wrapText from "../../WrapText.js";

const drawBVOCCommitteePresident = async (
  ctx,
  width,
  height,
  data,
  ...
  // Subject
  ctx.font = "bold 18px 'Times New Roman'";
  const subjectText = `Subject: Letter of Selection – ${committeeType} Committee President`;
  ...
  const paragraph1 = `We are pleased to inform you that, following the official voting process conducted among students and faculty members, you have been elected as the President of the ${committeeType} Committee for the B.Voc in Artificial Intelligence and Machine Learning program.`;
  currentY = wrapText(ctx, paragraph1, leftMargin, currentY, contentWidth, 19);
  currentY += 18;

  // Paragraph 2
  const paragraph2 = `Your selection reflects the confidence your peers and faculty have in your leadership, initiative, and organizational abilities. As the President, you are entrusted with leading your committee's initiatives, fostering collaboration among members, and contributing to the holistic growth of the student community.`;
  currentY = wrapText(ctx, paragraph2, leftMargin, currentY, contentWidth, 19);
  currentY += 18;

  // Closing
  const closing = `We congratulate you on this well-deserved selection and wish you continued success in all your endeavors.`;
...
export default drawBVOCCommitteePresident;
