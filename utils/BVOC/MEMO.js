...
const drawBVOCMemo = async (
  ...
  // Subject (Memo specific - typically prefixed with "MEMO:")
  ctx.font = "bold 16px 'Times New Roman'";
  const subjectText = `Subject: MEMO - ${subject}`;
  ...
  // "Regards," (instead of "Warm regards,")
  ctx.font = "bold 16px 'Times New Roman'";
  ctx.fillText("Regards,", leftMargin, currentY);
  currentY += 40;
  ...
  ctx.fillStyle = "#000000";
  ctx.fillText("To verify the authenticity of this memo", width / 3.3, 980);
  currentY += 25;

  // Verification URL (in black, not underlined)
  ctx.font = "18px 'Times New Roman'";
  ctx.fillStyle = "#000000";
