...
const drawBVOCOutstandingPerformance = async (
  ctx,
  width,
  height,
  data,
  ...
  // Subject (bold)
  ctx.font = "bold 18px 'Times New Roman'";
  const subjectText = `Subject: Appreciation For Outstanding Performance – ${name}`;
  ...
  const paragraph1 = `We  are delighted to recognize your remarkable dedication and achievement by awarding you the **Outstanding Performance** for the month of **${performanceMonth}** in the **B.Voc** program conducted by **Nexcore Alliance LLP**.`;
  ...
  // Third paragraph
  const paragraph3 = `We sincerely appreciate your hard work and congratulate you on this well-earned recognition. Continue maintaining this level of performance and strive for greater milestones in the upcoming months.`;
...
export default drawBVOCOutstandingPerformance;
