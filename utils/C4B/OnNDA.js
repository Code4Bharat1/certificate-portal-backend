...
const drawITOnboardingNDA = async (
  ctx,
  width,
  height,
  data,
  ...
  if (page === 1) {
    ...
    const whereas2 =
      "WHEREAS, the Company seeks to protect its confidential information from unauthorized disclosure, usage, or exploitation.";
...
export default drawITOnboardingNDA;
