...
const drawJoiningLetterUnpaid = async (
  ...
  if (page === 1) {
    ...
    const introPara = `We  are pleased to officially offer you the position of **${role}** at **Nexcore Alliance LLP**. This letter confirms your selection for our internship program and outlines the details of your training, internship role, and responsibilities.`;
    ...
    ctx.font = "16px 'Times New Roman'";
    const trainingPara =
      "Your initial three-week training will cover onboarding, digital marketing fundamentals, and tool familiarization. Upon successful completion of the training, your formal internship phase will commence.";
    currentY = wrapText(
      ctx,
      trainingPara,
      leftMargin,
    ...
    const performancePara =
      "Your performance will be assessed periodically, and based on your progress and commitment, you may become eligible for a performance-based stipend and additional project responsibilities. The detailed evaluation structure will be communicated during onboarding.";
    currentY = wrapText(
      ctx,
      performancePara,
      leftMargin,
