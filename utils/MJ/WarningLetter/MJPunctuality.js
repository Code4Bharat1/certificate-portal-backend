...
const drawMJPunctuality = async (
  ...
  // Paragraph 1
  const paragraph1 = `This  is to formally inform you that you have accumulated more than three (3) instances of late reporting during your employment with**MarketIQ Junction.** This reflects a continued lack of punctuality and non-adherence to workplace discipline, which is unacceptable and has been recorded as a disciplinary concern.`;
