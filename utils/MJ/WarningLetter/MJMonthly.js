...
const drawMJMonthly = async (
  ...
  const paragraph1 = `This  is to formally inform you that your attendance for the current month is **${attendancePercent}%,** which is below the minimum monthly attendance requirement set by ** MarketIQ Junction (a Nexcore Company).**`;
  ...
  const bullet2 = `• Your performance review, growth opportunities, and internal evaluations may be impacted, and`;
  currentY = wrapText(ctx, bullet2, leftMargin, currentY, contentWidth, 20);
  currentY += 14;

  // Paragraph 3
  const paragraph3 = `Regular monthly attendance is a critical component of professional discipline, accountability, and overall workplace performance. No further reminders will be issued. Any continuation of such behavior will lead to the strict enforcement of the consequences mentioned above, without exception.`;
