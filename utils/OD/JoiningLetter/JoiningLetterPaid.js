...
const drawODJoiningLetterPaid = async (
  ctx,
  width,
  height,
  data,
  ...
  if (page === 1) {
    ...
    // Stipend details
    ctx.font = "18px 'Times New Roman'";
    const stipendPara = `Internship  includes a **performance-based stipend of ₹${amount}/- per month**, effective from ${effectiveFrom}, upon successful completion of your first project and based on your performance evaluation. We are confident that with your hard work and consistent efforts, you will soon achieve the next levels of opportunities and greater responsibilities within our organization.`;
    ...
    // Closing paragraph
    const closingPara =
      "We  are delighted to have you as part of the team and are confident that this internship will serve as a strong foundation for your professional growth in technology.";
...
export default drawODJoiningLetterPaid;
