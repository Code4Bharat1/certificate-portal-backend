...
const drawODOnboardingNDA = async (
  ctx,
  width,
  height,
  data,
  ...
  if (page === 1) {
    ...
    const whereas1Para = `The  Recipient, during his tenure, had access to confidential, proprietary, and sensitive information of the Company related to operational activities, including but not limited to workflows, internal processes, logistics, and execution strategies; and`;
    ...
    const whereas2 =
      "WHEREAS, the Company intends to protect its operational confidential information from unauthorized disclosure, use, or commercial exploitation.";
    ...
    const section1Items = [
      "(a) Operational processes, standard operating procedures (SOPs), workflows, and execution methodologies.",
      "(b) Project timelines, internal reports, performance metrics, and operational strategies.",
      "(c) Vendor details, supply chain information, logistics data, pricing structures, and cost analyses.",
      "(d) System access credentials, internal tools, dashboards, operational documentation, and communication records.",
      "(e) Any other non-public operational information that contributes to the efficiency, competitiveness, or strategic functioning of the Company.",
    ];
...
export default drawODOnboardingNDA;
