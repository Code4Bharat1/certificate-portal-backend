...
const drawFSDMonthly = async (
  ...
  // Draw Header
  if (headerImg) {
    ctx.drawImage(headerImg, 0, 0, width, 195);
  }
  ...
  const paragraph1 = `This  is to formally inform you that your attendance for the current month is **${attendancePercent}%,** which is below the minimum monthly attendance requirement set by ** Nexcore Alliance LLP** for the successful continuation and completion of the course.`;
  ...
  // Paragraph 3
  const paragraph3 = `Regular monthly attendance is a critical component of your learning, discipline, and professional development. No further reminders will be given. Any continuation of such behavior will lead to the consequences mentioned above being enforced without exception.`;
