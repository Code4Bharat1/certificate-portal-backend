...
const drawFSDOfferLetter = async (
  ctx,
  width,
  height,
  data,
  ...
  if (page === 1) {
    ...
    const openingPara = `It  is with great pleasure that **Nexcore Alliance LLP** extends this Internship cum Training Offer for the position of **Full Stack Development Intern**.`;
...
export default drawFSDOfferLetter;
