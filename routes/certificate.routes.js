...
// Verify certificate
router.post('/verify', authenticate, certificateControllers.verifyCertificate)
...
router.get('/:id/download/pdf', authenticate, certificateControllers.downloadCertificateAsPdf)
