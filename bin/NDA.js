...
const drawC4BNDA = async (
  ...
  if (page === 1) {
    ...
    // Recipient details
    const recipientPara = `** ${name},**an individual who has been employed as a **${role}** with Nexcore Alliance LLP for a period of**${duration} months,**residing at **${
